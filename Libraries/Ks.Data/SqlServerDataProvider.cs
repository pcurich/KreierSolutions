...
namespace Ks.Data
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        {
            //pass some table names to  
//            var tablesToValidate = new[] { "Customer", "Discount", "Order", "Product", "ShoppingCartItem" };
            var tablesToValidate = new[] { "KsSystem"  };
            ...
            var initializer = new CreateTablesIfNotExist<KsObjectContext>(tablesToValidate, customCommands.ToArray());
