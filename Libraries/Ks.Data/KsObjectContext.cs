...
namespace Ks.Data
{
    ...
    ///     Object context
    /// </summary>
    public class KsObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public KsObjectContext(string nameOrConnectionString)
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            var typesToRegister = Assembly.GetExecutingAssembly().GetTypes()
                ...
                .Where(type => type.BaseType != null && type.BaseType.IsGenericType &&
                               type.BaseType.GetGenericTypeDefinition() == typeof (KsEntityTypeConfiguration<>));
