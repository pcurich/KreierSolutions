...
namespace Ks.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        protected virtual bool TryWriteGlobalAsax()
        {
            try
            {
                //When a new plugin is dropped in the Plugins folder and is installed into Ks.Commerce, 
                ...
                //The issue is described here: http://www.Ks.commerce.com/boards/t/10969/Ks.-20-plugin.aspx?p=4#51318
        ...
        public virtual string ServerVariables(string name)
        {
            ...
            try
            {
                ...
                //as described here http://www.Ks.commerce.com/boards/t/21356/multi-store-roadmap-lets-discuss-update-done.aspx?p=6#90196
        ...
        public virtual string GetStoreHost(bool useSsl)
        {
            ...
            if (DataSettingsHelper.DatabaseIsInstalled())
            {
                ...
                var ksSystemContext = EngineContext.Current.Resolve<IKsSystemContext>();
                var currentSystem = ksSystemContext.CurrentSystem;
                if (currentSystem == null)
                    throw new Exception("Current System cannot be loaded");
                ...
                if (useSsl)
                {
                    result = !String.IsNullOrWhiteSpace(currentSystem.SecureUrl) ?
                ...
                {
                    if (currentSystem.SslEnabled && !String.IsNullOrWhiteSpace(currentSystem.SecureUrl))
                    {
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            else
            {
                ...
                if (!success)
                {
                    throw new KsException("Ks.Commerce needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContext.Items["Ks.IsPOSTBeingDone"] == null)
                    return false;
                return Convert.ToBoolean(_httpContext.Items["Ks.IsPOSTBeingDone"]);
            }
            set
            {
                _httpContext.Items["Ks.IsPOSTBeingDone"] = value;
            }
        }
