...
using Ks.Core.Html.CodeFormatter;

namespace Ks.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.Ks.Commerce.com]my site[/url]
                // becomes: <a href="http://www.Ks.Commerce.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.Ks.Commerce.com[/url]
                // becomes: <a href="http://www.Ks.Commerce.com">http://www.Ks.Commerce.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]http://www.Ks.Commerce.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="http://www.Ks.Commerce.com/Content/Images/Image.jpg"></img>
