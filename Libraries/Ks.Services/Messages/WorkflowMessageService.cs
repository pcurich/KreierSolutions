...
namespace Ks.Services.Messages
{
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        public WorkflowMessageService(IMessageTemplateService messageTemplateService,
            IQueuedEmailService queuedEmailService, ILanguageService languageService, ITokenizer tokenizer,
            IEmailAccountService emailAccountService, IMessageTokenProvider messageTokenProvider,
            IKsSystemService ksSystemService, IKsSystemContext ksSystemContext,
        ...
        public virtual int SendCustomerRegisteredNotificationMessage(Customer customer, int languageId)
        {
            ...
            var store = _ksSystemContext.CurrentSystem;
            ...
            _messageTokenProvider.AddSystemTokens(tokens, store, emailAccount);
