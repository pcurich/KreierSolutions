...
namespace Ks.Web.Controllers
{
    public class InstallController : BasePublicController
    {
        ...
        public InstallController(IInstallationLocalizationService locService, KsConfig config)
        {
        ...
        private readonly KsConfig _config;
        ...
        public ActionResult Index()
        {
            ...
            var model = new InstallModel
            {
                ...
                SqlAuthenticationType = "windowsauthentication",//"sqlauthentication",
                SqlConnectionInfo = "sqlconnectioninfo_values",
                SqlServerCreateDatabase = true,
                UseCustomCollation = false,
                Collation = "SQL_Latin1_General_CP1_CI_AS",

                SqlServerName = @"IDEA-PC\MSSQLSERVER2014",
                SqlDatabaseName = "ACMR",
        ...
        public ActionResult Index(InstallModel model)
        {
            ...
            foreach (var dir in dirsToCheck)
                if (!FilePermissionHelper.CheckPermissions(dir, false, true, true, false))
                    ModelState.AddModelError("",
                        string.Format(_locService.GetResource("ConfigureDirectoryPermissions"),
            ...
            foreach (var file in filesToCheck)
                if (!FilePermissionHelper.CheckPermissions(file, false, true, true, true))
                    ModelState.AddModelError("",
                        string.Format(_locService.GetResource("ConfigureFilePermissions"),
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    {
                        //SQL CE
                        var databaseFileName = "Ks.Db.sdf";
                ...
                catch (Exception exception)
                {
                    ...
                    ModelState.AddModelError("",
                        string.Format(_locService.GetResource("SetupFailed"), exception.Message));
                }
            }
            return View(model);
        }
