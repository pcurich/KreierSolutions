...
namespace Ks.Admin.Controllers
{
    public partial class MessageTemplateController : BaseAdminController
    {
        ...
        //    model.AvailableStores = _ksSystemService
        //        .GetAllStores()
        //        .Select(s => s.ToModel())
        //        .ToList();
        ...
        //    var allStores = _ksSystemService.GetAllStores();
        ...
        public ActionResult List()
        {
            ...
            foreach (var s in _ksSystemService.GetAllKsSystems())
        ...
        public ActionResult List(DataSourceRequest command, MessageTemplateListModel model)
        {
            ...
            var gridModel = new DataSourceResult
            {
                Data = messageTemplates.Select(x =>
                {
                    ...
                    var stores = _ksSystemService
                            .GetAllKsSystems()
                            //.Where(s => templateModel.SelectedStoreIds.Contains(s.Id))
                            .ToList();
